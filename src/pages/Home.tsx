      ...
      >
        ...
        >
          ...
          <div className="z-10 text-center flex flex-col items-center mt-32 md:mt-28 md:ml-24 transition-transform duration-500 group-hover:scale-105 relative">
            ...
            <h2 className="text-3xl md:text-6xl font-serif font-bold mb-1 md:mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[#185B5A] to-[#D9B73B]">
              Natural Dental
            </h2>
            <p className="text-[#185B5A]/90 font-medium text-sm md:text-lg mb-0.5 md:mb-1">C.D.E.O Lorena Arellano Rosales</p>
            <p className="text-[#185B5A]/80 text-xs md:text-sm mb-4 md:mb-6 max-w-xs">Odontología Integral y Ortodoncia</p>
