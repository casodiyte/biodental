      ...
      >
        ...
        >
          ...
          <div className="z-10 text-center flex flex-col items-center mt-32 md:mt-28 md:ml-24 transition-transform duration-500 group-hover:scale-105 relative">
            ...
            <h2 className="text-3xl md:text-6xl font-serif font-bold mb-1 md:mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[#7DB81B] via-[#0891B2] via-[50%] to-[#0891B2]">
              Natural Dental
            </h2>
