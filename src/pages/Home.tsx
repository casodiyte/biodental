    ...
    <PageTransition className="relative min-h-screen">
      ...
      >
        ...
        >
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -right-32 md:-right-56 w-[55%] md:w-[65%] h-full pointer-events-none mix-blend-multiply opacity-80 z-0 flex items-end justify-end pb-0 pr-0">
