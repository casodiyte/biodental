    ...
    <PageTransition className="relative min-h-screen">
      ...
      >
        ...
        >
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -right-32 md:-right-60 w-[55%] md:w-[65%] h-full pointer-events-none mix-blend-multiply opacity-80 z-0 flex items-end justify-end pb-0 pr-0">
          ...
          <div className="z-10 text-center flex flex-col items-center mt-32 md:mt-28 md:ml-24 transition-transform duration-500 group-hover:scale-105 relative">
            ...
            <h2 className="text-3xl md:text-6xl font-serif font-bold mb-1 md:mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[#0891B2] via-[#0891B2] via-[55%] to-[#22D3EE]">
              Natural Dental
            </h2>
